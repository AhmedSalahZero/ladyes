...
{ 
    ...
    public function rules()
    {
		...
		$model = $this->route('bonus') ;
		$HValidationRules = HValidation::rules('bonuses', $model , Request::isMethod('post'));
        return 
		[
			'model_type'=>'required',
			'model_id'=>'required',
	...
	public function messages()
	{
		return [
			...
			'amount.required'=>__('Please Enter :attribute' , ['attribute'=>__('Bonus Amount')]),
			'amount.gt'=> __('Only Greater Zero Allowed For :attribute' , ['attribute'=>__('Bonus Amount')]) ,
		];
	}
