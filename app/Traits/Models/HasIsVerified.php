...
trait HasIsVerified 
{
	...
	public function sendVerificationCodeViaEmail()
	{
		$email = $this->getEmail();
	...
	public function sendVerificationCodeMessage()
	{
		...
		if($responseArray['status']){
			return redirect()->back()->with('success',__('Verification Code Has Been Sent To Your Whatsapp') );
		}
