                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a
                                        href="{{route('admin.cars_models.index')}}">{{__('msg.cars_models')}}</a>
                                </li>
                                <li class="breadcrumb-item active">{{__('msg.cars_models')}}
                                </li>
                            </ol>
                        </div>
                    </div>
                            ...
                            <div class="card">
                                @if(admin()->check_route_permission('admin.cars_models.edit') == 1)
                                    <div class="card-header">
                                        <h4 class="card-title" id="basic-layout-form">{{__('msg.cars_models')}}</h4>
                                    ...
                                    <div class="card-content collapse show">
                                        <div class="card-body">
                                            @if($cars_model)
                                                <form class="form"
                                                      action="{{route('admin.cars_models.update',$cars_model->id)}}"
                                                      method="post"
                                                    ...
                                                    <div class="form-body">
                                                        ...
                                                        <div class="form-actions">
                                                            <a href="{{route('admin.cars_models.index')}}" type="button"
