                                    ...
                                    <form class="form" action="{{$route}}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
												    <x-form.image-uploader :name="'logo'"  :id="'logo-id'"  :label="__('Logo')" :image="isset($model) && $model->getFirstMedia('logo') ? $model->getFirstMedia('logo')->getFullUrl() : getDefaultImage()"></x-form.image-uploader>
