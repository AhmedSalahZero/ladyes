                                ...
                                @if(admin()->check_route_permission('admin.addition_services.edit') == 1)
                                    ...
                                    <div class="card-content collapse show">
                                        <div class="card-body">
                                            @if($addition_service)
                                                <form class="form"
                                                      action="{{route('admin.addition_services.update',$addition_service->id)}}"
                                                      method="post"
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" id="name_ar"
                                                                           ...
                                                                           value="{{ $addition_service->name_ar }}"
                                                                           name="name_ar">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" id="name_en"
                                                                           ...
                                                                           value="{{ $addition_service->name_en }}"
                                                                           name="name_en">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="number" step="any" min="0" id="price"
                                                                           ...
                                                                           value="{{ (float)$addition_service->price }}"
                                                                           name="price">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                    ...
                                                                    <div class="col-md-9">
                                                                        <div class="float-left">
                                                                            <input type="checkbox" name="active"
                                                                                   ...
                                                                                   id="switchBootstrap2" {{$addition_service->active == 1 ? 'checked' : ''}} />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
