                                ...
                                <div class="card-body card-dashboard">
                                    <x-tables.basic-table>
                                        <x-slot name="header">
                                            ...
                                            <th class="th-global-class  text-center">{{__('Car Make')}}</th>
                                            <th class="th-global-class  text-center">{{__('Logo')}}</th>
                                        ...
                                        <x-slot name="body">
                                            ...
                                            <tr data-id="{{ $model->id }}" class="deleteable-row">
                                                ...
                                                <td class="text-center">{{$model->getMakeName($lang)}}</td>
                                                <td class="text-center">
													<img class="default-img-in-td" src="{{ $model->getFirstMedia('logo') ? $model->getFirstMedia('logo')->getFullUrl() : getDefaultImage() }}">
												</td>
