                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <div class="profile-head">
                                                                                    ...
                                                                                    <h4 class="proile-rating font-weight-bold">{{ __('Total Balance') }} : <span class="font-weight-bold">{{ number_format($model->getTotalWalletBalance()) }} {{ $model->getCountry() ? $model->getCountry()->getCurrencyFormatted($lang) : __('N/A') }} </span></h4>
