                                                    ...
                                                    <div class="form-body">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" id="id_number"
                                                                           ...
                                                                           value="{{ $driver->id_number }}" name="id_number"
                                                                    >
                                                                    @error('id_number')
                                                                    <span class="text-danger">{{$message}}</span>
                                                                    @enderror
                                                                    ...
                                                                    <div class="col-md-9">
                                                                        <div class="float-left">
                                                                            <input type="checkbox" name="active"
                                                                                   ...
                                                                                   id="switchBootstrap2" {{$driver->active == 1 ? 'checked' : ''}}/>
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" id="car_number"
                                                                           ...
                                                                           value="{{ $driver->car_number }}" name="car_number"
                                                                    >
                                                                    @error('car_number')
                                                                    <span class="text-danger">{{$message}}</span>
                                                                    @enderror
                                                            ...
                                                            <div class="col-md-6 d-flex">
                                                                <div class="col-md-2">
                                                                    <input type="radio" {{$driver->car_type == 1 ? 'checked' : ''}} class="form-control border-primary" value="1" name="car_type">
                                                                ...
                                                                <div class="col-md-2">
                                                                    <input type="radio" {{$driver->car_type == 2 ? 'checked' : ''}} class="form-control border-primary" value="2" name="car_type">
                                                                ...
                                                                <div class="col-md-2">
                                                                    <input type="radio" {{$driver->car_type == 3 ? 'checked' : ''}} class="form-control border-primary" value="3" name="car_type">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" id="car_color"
                                                                           ...
                                                                           value="{{ $driver->car_color }}" name="car_color"
                                                                    >
                                                                    @error('car_color')
                                                                    <span class="text-danger">{{$message}}</span>
                                                                    @enderror
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <select class="select2 form-control" name="prod_year">
                                                                        @for($i=date('Y');$i>=2010;$i--)
                                                                            <option value="{{$i}}" {{$driver->prod_year == $i ? 'selected' : ''}}>{{$i}}</option>
                                                                        @endfor
                                                                    </select>
                                                                </div>
                                                            </div>
                                                                    ...
                                                                    <select class="select2 form-control" name="model_id">
                                                                        @if(count($cars_models) > 0)
                                                                            @foreach($cars_models as $model)
                                                                                <option
                                                                                    value="{{$model->id}}" {{$driver->model_id == $model->id ? 'selected' : ''}}>{{$model->name}}</option>
                                                                            @endforeach
                                                                        @endif
                                                                    ...
                                                                    <select class="select2 form-control" id="country" name="country_id">
                                                                        @if($countries && count($countries) > 0)
                                                                            @foreach($countries as $country)
                                                                                <option value="{{$country->id}}" {{$driver->country_id == $country->id ? 'selected' : ''}}>{{$country->name}}</option>
                                                                            @endforeach
                                                                        @endif
                                                                    </select>
                                                                </div>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group ">
                                                                    ...
                                                                    <input type="file"
                                                                           ...
                                                                           name="id_image">
                                                                    @if($driver->file('id_image') && $driver->file('id_image')->file_path)
                                                                    <a target="_blank" href="{{asset('public'.$driver->file('id_image')->file_path)}}">
                                                                        <img src="{{asset('public'.$driver->file('id_image')->file_path)}}" width="100px" class="mt-1">
                                                                    </a>
                                                                    @else
                                                                        <span class="text-warning">{{__('msg.file_not_uploaded')}}  </span>
                                                                    @endif
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group ">
                                                                    ...
                                                                    >
                                                                    @if($driver->file('driving_license') && $driver->file('driving_license')->file_path)
                                                                        <a target="_blank" href="{{asset('public'.$driver->file('driving_license')->file_path)}}">
                                                                            <img src="{{asset('public'.$driver->file('id_image')->file_path)}}" width="100px" class="mt-1">
                                                                        </a>
                                                                    @else
                                                                        <span class="text-warning">{{__('msg.file_not_uploaded')}}  </span>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group ">
                                                                    ...
                                                                    <input type="file"
                                                                           ...
                                                                           name="car_image"
                                                                    >
                                                                    @if($driver->file('car_image') && $driver->file('car_image')->file_path)
                                                                        <a target="_blank" href="{{asset('public'.$driver->file('car_image')->file_path)}}">
                                                                            <img src="{{asset('public'.$driver->file('car_image')->file_path)}}" width="100px" class="mt-1">
                                                                        </a>
                                                                    @else
                                                                        <span class="text-warning">{{__('msg.file_not_uploaded')}}  </span>
                                                                    @endif
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group ">
                                                                    ...
                                                                    >
                                                                    @if($driver->file('car_front_image') && $driver->file('car_front_image')->file_path)
                                                                        <a target="_blank" href="{{asset('public'.$driver->file('car_front_image')->file_path)}}">
                                                                            <img src="{{asset('public'.$driver->file('car_front_image')->file_path)}}" width="100px" class="mt-1">
                                                                        </a>
                                                                    @else
                                                                        <span class="text-warning">{{__('msg.file_not_uploaded')}}  </span>
                                                                    @endif
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group ">
                                                                    ...
                                                                    <input type="file"
                                                                           ...
                                                                           name="car_back_image">
                                                                    @if($driver->file('car_back_image') && $driver->file('car_back_image')->file_path)
                                                                        <a target="_blank" href="{{asset('public'.$driver->file('car_back_image')->file_path)}}">
                                                                            <img src="{{asset('public'.$driver->file('car_back_image')->file_path)}}" width="100px" class="mt-1">
                                                                        </a>
                                                                    @else
                                                                        <span class="text-warning">{{__('msg.file_not_uploaded')}}  </span>
                                                                    @endif
