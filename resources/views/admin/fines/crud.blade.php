                                    ...
                                    <form class="form" action="{{$route}}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <x-form.input :id="'amount'" :label="__('Fine Amount')" :type="'text'" :name="'amount'" :is-required="true" :model="$model??null" :placeholder="__('Please Enter :attribute',['attribute'=>__('Amount')])"></x-form.input>
                                                </div>
