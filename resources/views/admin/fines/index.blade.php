                                ...
                                <div class="card-body card-dashboard">
                                    <x-tables.basic-table>
                                        <x-slot name="header">
                                            ...
                                            <th class="th-global-class  text-center">{{__('Is Paid')}}</th>
											<th class="th-global-class  text-center">{{__('User Note')}}</th>
                                        ...
                                        <x-slot name="body">
                                            ...
                                            <tr data-id="{{ $model->id }}" class="deleteable-row">
                                                ...
                                                <td class="text-center">{{$model->getIsPaidFormatted()}}</td>
												 {{-- <td class="text-center">{{$model->getStartDateFormatted()}}</td> --}}
												 <td class="text-center">{{$model->getNoteFormatted()}}</td>
