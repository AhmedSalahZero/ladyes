                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="row">
												...
												{{-- <input type="hidden" name="discount_type" value="percentage" > --}}
                                                    <x-form.input :id="'discount_amount'" :label="__('Value')" :type="'text'" :name="'discount_amount'" :is-required="true" :model="$model??null" :placeholder="__('Please Enter :attribute',['attribute'=>__('Amount')])"></x-form.input>
                                                </div>
												<div class="col-md-6">
