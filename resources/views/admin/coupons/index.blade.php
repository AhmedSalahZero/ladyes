                                ...
                                <div class="card-body card-dashboard">
                                    <x-tables.basic-table>
                                        <x-slot name="header">
                                            ...
                                            <th class="th-global-class  text-center">{{__('Code')}}</th>
                                            <th class="th-global-class  text-center">{{__('Number Of Uses')}}</th>
                                            <th class="th-global-class  text-center">{{__('Number Of Applies')}}</th>
											<th class="th-global-class  text-center">{{__('Start Date')}}</th>
                                            <th class="th-global-class  text-center">{{__('End Date')}}</th>
                                            <th class="th-global-class  text-center">{{__('Discount')}}</th>
                                        ...
                                        <x-slot name="body">
                                            ...
                                            <tr data-id="{{ $model->id }}" class="deleteable-row">
                                                ...
                                                <td class="text-center">{{$model->getCode()}}</td>
                                                <td class="text-center">{{$model->getNumberOfUses()}}</td>
                                                <td class="text-center">{{$model->getNumberOfApplies()}}</td>
                                                ...
                                                <td class="text-center">
                                                    {{$model->isAvailableForUsing() ? __('Available') : __('Not Available')}}
                                                </td>
                                                @if($user->can(getPermissionName('update')) || $user->can(getPermissionName('delete')) )
