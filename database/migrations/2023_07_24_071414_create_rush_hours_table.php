...
class CreateRushHoursTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('rush_hours', function (Blueprint $table) {
            ...
            $table->decimal('cash_fees',14,4)->default(1)->comment('الرسوم اللي هيتم تطبيقها علي العميل في حالة قام بالغاء الرحلة');
            $table->decimal('first_travel_bonus',14,4)->default(1)->comment('الرسوم اللي هيتم تطبيقها علي العميل في حالة قام بالغاء الرحلة');
