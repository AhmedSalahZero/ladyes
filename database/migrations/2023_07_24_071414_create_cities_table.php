...
class CreateCitiesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('cities', function (Blueprint $table) {
            ...
            $table->decimal('cash_fees',14,2)->default(1)->comment('الرسوم اللي هيتم تطبيقها علي العميل في حالة قام بالدفع عن طريق الكاش');
            $table->decimal('first_travel_bonus',14,2)->default(1)->comment('هو مبلغ يتم اضافتة في محفظة العميل تلقائيا بعد انتهاء اول رحلة بنجاح')->after('id');
